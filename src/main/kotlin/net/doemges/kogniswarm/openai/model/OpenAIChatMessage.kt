...
class OpenAIChatMessage(
    ...
    override fun toString(): String = "OpenAIChatMessage(role=$role, content=$content, name=$name)"

    fun asChatMessage(): ChatMessage =
        ChatMessage(role ?: ChatRole.User, content ?: error("content must be set"), name).also {
            logger.debug("Created ChatMessage: $it")
        }
