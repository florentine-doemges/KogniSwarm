...
import net.doemges.kogniswarm.tool.service.GoogleSearchApiClientService
...
@Service
class GoogleSearchToolProcessor(
    private val googleSearchApiClientService: GoogleSearchApiClientService,
    parameterParser: ParameterParser,
    private val objectMapper: ObjectMapper
) : BaseToolProcessor(parameterParser) {

    companion object {
        private val logger = LoggerFactory.getLogger(GoogleSearchToolProcessor::class.java)
    }
    ...
    private tailrec fun ProducerScope<Item>.tailrecFetchItems(
        ...
        val items = googleSearchApiClientService.fetchItems(query, start, currentNum)
